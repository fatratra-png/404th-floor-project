...
const TEAM = {
  m1: "@isaacabderman-creator", // System Architect
  m2: "@rahobizafysantatra-bot", // UI/UX Engineer
  m3: "@fiandriananaprime", // Frontend Developer
  m4: "@spicy_dude/fatratra_npc", // DevOps Engineer ← TOI, change ici
};
...
const Music = (() => {
  ...
  function playGlitchLayer() {
    function burst() {
      ...
      src.buffer = buf;
      filt.type = "bandpass";
      filt.frequency.value = 600 + Math.random() * 2000;
      filt.Q.value = 5;
  ...
  function playMelody() {
    ...
    const mel = [
      293.7, 349.2, 392.0, 440.0, 523.3, 440.0, 392.0, 349.2, 293.7, 261.6,
      293.7, 349.2,
    ];
    const bpm = 120;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!document.getElementById("skip-btn")) {
    ...
    btn.id = "skip-btn";
    btn.className =
      "absolute bottom-10 right-8 z-50 opacity-0 font-mono text-xs text-slate-600 border border-slate-800 px-4 py-2 hover:text-primary hover:border-primary/40 transition-all tracking-widest";
